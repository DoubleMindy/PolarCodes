...
std::vector<double> ScRecursiveDecoder::GetLeftMessage(std::vector<double>::iterator leftIt, std::vector<double>::iterator rightIt, std::size_t n) {

	std::vector<double> out(n, 0);
	for (std::size_t i = 0; i < n; i++, leftIt++, rightIt++)
	{
...
std::vector<double> ScRecursiveDecoder::GetRightMessage(std::vector<double>::iterator leftIt, std::vector<double>::iterator rightIt, std::vector<int> uHat, std::size_t n) {
	std::vector<double> out(n, 0);
